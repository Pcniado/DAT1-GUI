...
namespace DAT1.Files {
	public abstract class TextureBase: DAT1 {
		...
		private void WriteDDSHeader(BinaryWriter bw, uint width, uint height, uint mipmaps) {
			...
			// pixelformat
			bw.Write(new byte[] { 0x20, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x44, 0x58, 0x31, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
